...
st.markdown(
    """
    #### API Keys
    Both of the API keys required are free and easy to get.
    However, I am working on add huggingface support for LLama 2.0
    """
)
...
st.caption(
    "*Required for all apps; get it [here](https://platform.openai.com/account/api-keys).*"
)
